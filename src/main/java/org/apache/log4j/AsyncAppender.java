...
public class AsyncAppender extends AppenderSkeleton implements AppenderAttachable {
    ...
    public AsyncAppender() {
        ...
        // set the dispatcher priority to lowest possible value  dispatcher.setPriority(Thread.MIN_PRIORITY);
    ...
    public void append(final LoggingEvent event) {
        //   if dispatcher thread has died then   append subsequent events synchronously
        //   See bug 23021
    ...
    public void setBufferSize(final int size) {
        //   log4j 1.2 would throw exception if size was negative  and deadlock if size was zero.
        if (size < 0) {

...
/**
 ...
 is created. This instance is passed around to the different log4j components.
...
public class LoggingEvent implements java.io.Serializable {
     ...
     * is a flyweight.  Due to its special seralization it cannot be declared final either.
     *
     ...
     * Please do not access it directly. Use the {@link #getLevel} method instead.
     *
     * */
     ...
     *  Note that its value is always false when  serialized.
     *  Thus, a receiving SocketNode will never use it's own (incorrect) NDC. See also writeObject method.
     *  */
